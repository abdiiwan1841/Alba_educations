                            ...
                            <table class="table display data-table text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Phone</th>
                                        <th>E-mail</th>
                                        <th>Addmissiom Date</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if (isset($users_students)) {
                                        if ($users_students != 0) {
                                            $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $student->email_main; ?></td>
                                                <td><?php echo $student->addmissiomDate; ?></td>
                                                
                                                <td > 
                                                    <a href="#" class="deleteStudentBtn" id="<?php echo $student->user_student_id; ?>" >
...
<script>
     $(".deleteStudentBtn").click(function(){
      var verify = confirm("Delete this Student permanently?");
      if (verify == true) {
        var id = $(this).attr('id');
        window.location.href = "<?php echo base_url().'/admin/remove_student/'?>"+id;
      } else {
      }
    })
