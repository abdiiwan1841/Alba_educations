            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body-new">
                        <form action="<?php echo base_url('admin/adminAddStudent') ?>" method="post" enctype="multipart/form-data">
                        <?php
                            if (isset($reg_error)) {
                            ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="email" name="email_main" class="form-control"  placeholder="Enter your email">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="date" name="dob" class="form-control"  placeholder="Enter your Phone Number">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="text" name="timeZone" class="form-control"  placeholder="Enter your Time Zone">
                                    </div>
                                </div>
                                <!-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="file" name="idProof" class="form-control"  placeholder="">
                                    </div>
                                </div> -->
                            </div>
                            <div class="heading-layout1">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Addmission Date</label>
                                        <span class="required">*</span>
                                        <input type="date" name="addmissiomDate" class="form-control"  placeholder="">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <div class=""></div>
                                        <select class="fillGradeSubjects form-select" name="subject" aria-label="">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="text" class="form-control" name="feePerSession"  placeholder="" required>
                                    </div>
                                </div>
                            </div>
                            <div class="heading-layout1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="number" class="form-control" name="fatherPhone"  placeholder="Enter Father Phone Number">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="number" class="form-control" name="motherPhone"  placeholder="Enter Mother Phone Number">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="file" name="idProofParent" class="form-control"  placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="heading-layout1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <span class="required">*</span>
                                        <input type="email" class="form-control" name="email"  placeholder="Enter your Login Email">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    <div class="mb-3">
