        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Assign  Curriculum to enrollerd students</h3>
                    <ul>
                        <li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="card height-auto">
                            <div class="card-body-new">
                                ...
                                ?>
                                <form class="mg-b-20" method="POST" action="<?php echo base_url('admin/assignCurriculumToStudents');?> " enctype="multipart/form-data">
                                    <div class="row">
                                            ...
                                            if (isset($curriculum)) {
                                                if ($curriculum != 0) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if (isset($users_students) && $users_students != 0){
                                                                foreach ($users_students as $users_student) {
                                                                    if($users_student->user_student_id == $curr->student)
                                                                    {
                                                        ...
                                                        <td class="" >
                                                            <a href="<?php echo base_url($curr->file); ?>" download>
                                                                <span class="badge bg-success">Download</span>
                                                              </a>
                                                        </td>
                                                        <td  > 
                                                            <a href="#" class="deleteCurriculumBtn" id="<?php echo $curr->curriculum_id; ?>" >
...
<script>
        $(".deleteCurriculumBtn").click(function(){
      var verify = confirm("Delete this Cirriculum permanently?");
      if (verify == true) {
        var id = $(this).attr('id');
        window.location.href = "<?php echo base_url().'/admin/remove_curriculum/'?>"+id;
      } else {
      }
    })
