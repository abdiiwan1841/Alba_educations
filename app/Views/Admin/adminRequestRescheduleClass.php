                            ...
                            <div class="card-body-new">
                                ...
                                <div class="table-responsive">
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                            <?php 
                                            if (isset($reschedule_class)&& is_array($reschedule_class)) {
                                                if (count($reschedule_class) > 0) {
                                                    foreach($reschedule_class as $reschedule)
                                                    {?>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td><?php  
                                                             if (isset($users_students) && $users_students != 0){
                                                                    foreach ($users_students as $student) {
                                                                        if($student->user_student_id == $reschedule->student)
                                                                        {
                                                                            echo $student->name;
                                                                            break;
                                                                        } 
                                                            ...
                                                            <td><?php echo $reschedule->phone; ?></td>
                                                            <td><?php echo $reschedule->date; ?></td>
                                                            <td><?php echo $reschedule->time; ?></td>
                                                            <td><?php echo $reschedule->message; ?></td>
                                                            <td class="removeBtn" > 
                                                                <a href="#" >
