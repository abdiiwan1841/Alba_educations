                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    if (isset($users_teachers)) {
                                        if ($users_teachers != 0) {
                                            $i = 1;
                                            foreach($users_teachers as $student)
                                            { ?>
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                ...
                                                <td  > 
                                                     <a href="#" class="deleteTeacherBtn" id="<?php echo $student->user_teacher_id; ?>" >
...
<script>
     $(".deleteTeacherBtn").click(function(){
      var verify = confirm("Delete this Teacher permanently?");
      if (verify == true) {
        var id = $(this).attr('id');
        window.location.href = "<?php echo base_url().'/admin/remove_teacher/'?>"+id;
      } else {
      }
    })
