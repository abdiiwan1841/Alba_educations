        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Assign  more subject to already enrollerd students</h3>
                    <ul>
                        <li>
                            ...
                            <div class="card-body-new">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>Assign  more subject to enrolled students</h3>
                                    </div>
                                ...
                                ?>
                                <form class="mg-b-20" method="POST" action="<?php echo base_url('admin/assignSubjectsToStudents');?> " enctype="multipart/form-data">
                                    <div class="row">
                            ...
                            <div class="card-body-new">
                                ...
                                <div class="table-responsive">
                                    <table class="table display data-table text-center text-nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            if (isset($subjects_students)) {
                                                if ($subjects_students != 0) {
                                                    $i = 1;
                                                    foreach($subjects_students as $subjects_student)
                                                    { ?>
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                            ...
                                                            <?php 
                                                                if (isset($grades) && $grades != 0){
                                                                    foreach ($grades as $grade) {
                                                                        // if($grade->grade_id == $subjects_student->grade_id)
                                                                        // {
                                                        ...
                                                        <td>
                                                            ...
                                                            if (isset($users_students) && $users_students != 0){
                                                                foreach ($users_students as $users_student) {
                                                                    if($users_student->user_student_id == $subjects_student->student_id)
                                                                    {
