...
<html lang="en">
  <head>
    ...
    <title>Audit Report - Alba Education</title>
                  ...
                  <table class="table">
                    <thead>
                      <?php
                        ...
                        ?>
                      <tr>
                        <th scope="col">Report from admin</th>
                    ...
                    <tbody>
                      <?php 
                        ...
                        if (isset($admin_audit_report) && is_array($admin_audit_report)) {
                          ...
                          <tr>
                            <td>
                                <span class="text-dark"><?php echo $report->comment; ?></span>
                              </a>
                            </td>
                            <td>
                              <a href="#">
                                <span class="badge bg-info text-dark" data-bs-toggle="modal" href="#leaveComment" role="button">Comment</span>
                              </a>
                              <div class="modal fade" id="leaveComment" aria-hidden="true" aria-labelledby="leaveComment" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" >Leave Comment</h5>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body rounded">
                                      <form action="<?php echo base_url('teacher/audit_reply'); ?>" method="post" >
                                        <div class="mb-3">
                                          <label for="inputChangeRequest" class="form-label">Write Here</label>
                                          <input type="hidden" value="<?php echo $report->audit_id; ?>" name="audit_id">
                                          <textarea class="form-control" name="teacher_comment" id="inputChangeRequest"></textarea>
                                        </div>
