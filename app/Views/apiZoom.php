<?php
require_once APPPATH.'Views/php-jwt-master/src/BeforeValidException.php';
require_once APPPATH.'Views/php-jwt-master/src/ExpiredException.php';
require_once APPPATH.'Views/php-jwt-master/src/SignatureInvalidException.php';
require_once APPPATH.'Views/php-jwt-master/src/JWT.php';

use \Firebase\JWT\JWT;

function createMeeting($data,$API_KEY,$API_SECRET,$EMAIL_ID)
{
