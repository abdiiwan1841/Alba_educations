...
<html lang="en">
  <head>
    ...
    <title>Session History - Alba Education</title>
                    ...
                    <tbody>
                          <?php
                            ...
                            foreach ($sessions_history as $session_history) {
                                    ...
                                    <?php 
                                        if (isset($subjects) && $subjects != 0){
                                            foreach ($subjects as $subject) {
                                                if($subject->subject_id == $session_history->subject)
                                                {
                                ...
                                <td><?php echo $session_history->strt_time; ?></td>
                                <td><?php echo $session_history->timing; ?></td>
                                <td><?php echo $session_history->remarks; ?></td>
                                <td class="removeBtn" > 
                                  <a href="#" >
