...
<html lang="en">
  <head>
    ...
    <title>Live Classes - Alba Education</title>
          ...
          <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12">
            <section class="mainContent mt-5">
              ...
              <div class="row m-5">
                ...
                <!--                      align-items-center-->
                <!--                      p-2-->
                <!--                      calenderTimeContent bg-danger rounded-->
                <!--                    "-->
                <!--                  >-->
                <!--                    <a href="#" class="me-3">-->
                ...
                <!--                    </a>-->
                <!--                    <div class="p-0">-->
                <!--                      <strong class="text-light"> Client Meeting</strong>-->
                <!--                      <div class="pe-3 text-light">-->
                ...
                <!--                      align-items-center-->
                <!--                      p-2-->
                <!--                      calenderTimeContent bg-info round-->
                <!--                    "-->
                <!--                  >-->
                <!--                    <a href="#" class="me-3">-->
                <!--                      <i class="fas fa-video"></i>-->
