...
<head>
    ...
    <title>Student Login - Alba Educations</title>
        ...
        <div class="container position-relative d-flex justify-content-center">
          <div class="row login-area">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
             <form method="POST" action="<?php echo base_url('student_login'); ?>">
             <?php
                if (isset($login_res)) {
                ?>
               ...
               <div class="row bg-fe4a55 form-area-wrapper">
                 ...
                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center others-links">
                   <a href="<?php echo base_url('teacher_login'); ?>" >Login as a Teacher </a>
                 ...
                 <div class="login-shapes">
                   <div class="loginshape1">
                     <img src="<?php echo base_url('/public/FrontEnd/Image/k-shape9.png') ?>" alt="">
                   </div>
                   <div class="loginshape2">
                     <img src="<?php echo base_url('/public/FrontEnd/Image/shape13.png') ?>" alt="">
                   </div>
                 </div>
        ...
        <div class="premium-access-area pad-top-bottom-100">
          <div class="container">
            <div class="premium-access-content">
              ...
              <h2>Connect Us</h2>
              <p>In case of any query, Please contact us</p>
              <a href="<?php  echo base_url('aboutUs_contact'); ?>" class="button">
                <i class="fas fa-phone"></i>
                Contact Us <span></span>
              </a>
            </div>              
          </div>
          <div class="aboutUs-shape5">
            <img src="<?php echo base_url('/public/FrontEnd/Image/k-shape5.png') ?>" alt="Shape Image">
          </div>
          <div class="aboutUs-shape6">
            <img src="<?php echo base_url('/public/FrontEnd/Image/kids4.png') ?>" class="shape-img-img" alt="Shape Image">
          </div>
          <div class="aboutUs-shape7">
            <img src="<?php echo base_url('/public/FrontEnd/Image/banner-shape15.png') ?>" alt="Shape Image">
          </div>
