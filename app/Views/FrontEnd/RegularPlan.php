...
<head>
    ...
    <title>Regular-Plan - Alba Educations</title>
...
<body>
    <?php  include('public/FrontEnd/inc/header.php'); ?>
      <section class="section-top margin-top-5">
          <div class="container text-center">
              ...
              <div class="section-sub-heading">
                  <h5>
                      <strong>Enter Your Details to Buy Regular Plan</strong>
                  </h5>
              </div>
      ...
      <section>
        <div class="container mt-5  d-flex justify-content-center">
            <div class="row plan-form bg-fe4a55  ">
                <form action="<?php echo base_url('/regular_plan') ?>" method="post">
                    <?php
                      if (isset($reg_error)) {
                      ?>
...
$(".expand-1").click(function(){
      ...
      <script>
        ...
        document.getElementById("amount2").value = inputAmt * 5;
      }
      </script>
</body>
</html>